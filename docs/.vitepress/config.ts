  ...
  themeConfig: {
    ...
    sidebar: [{      
      ...
      items: [
        ...
        { text: 'Métodos de Matriz: Métodos Mutadores', link: '/how-to-use-array-methods-in-javascript-mutator-methods' },
        { text: 'Métodos de Matriz: Métodos de Acceso', link: '/how-to-use-array-methods-in-javascript-accessor-methods' },
        { text: 'Métodos de Matriz: Métodos de Iteración', link: '/how-to-use-array-methods-in-javascript-iteration-methods' },           
        { text: 'Objetos', link: '/understanding-objects-in-javascript' },
        { text: 'Fecha y la Hora', link: '/understanding-date-and-time-in-javascript' },
